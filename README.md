<!-- registry-sync: version=9.13.0; skills=1405; stars=32379; updated_at=2026-04-12T16:39:25+00:00 -->
# 🌌 Antigravity Awesome Skills: 1,405+ Agentic Skills for Claude Code, Gemini CLI, Cursor, Copilot & More

> **Installable GitHub library of 1,405+ agentic skills for Claude Code, Cursor, Codex CLI, Gemini CLI, Antigravity, and other AI coding assistants.**
...
- **Broad coverage with real utility**: 1,405+ skills across development, testing, security, infrastructure, product, and marketing.
...
If you want a faster answer than "browse all 1,405+ skills", start with a tool-specific guide:
