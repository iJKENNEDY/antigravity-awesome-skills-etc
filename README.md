<!-- registry-sync: version=11.1.0; skills=1457; stars=37158; updated_at=2026-05-11T15:17:43+00:00 -->
# 🌌 Antigravity Awesome Skills: 1,457+ Agentic Skills for Claude Code, Gemini CLI, Cursor, Copilot & More

> **Installable GitHub library of 1,457+ agentic skills for Claude Code, Cursor, Codex CLI, Gemini CLI, Antigravity, and other AI coding assistants.**
...
- **Broad coverage with real utility**: 1,457+ skills across development, testing, security, infrastructure, product, and marketing.
...
- [Browse 1,457+ Skills](#browse-1457-skills)
...
If you want a faster answer than "browse all 1,457+ skills", start with a tool-specific guide:
